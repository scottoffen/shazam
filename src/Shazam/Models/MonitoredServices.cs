...
namespace Shazam.Models
{
	...
	internal class MonitoredServices
	{
		...
		public int CountAutoStart
		{
			get { return _services.Count(service => service.AutoStart); }
		}

		public int CountAutoStop
		{
			get { return _services.Count(service => service.AutoStop); }
		}
